...
public class Jogar extends JFrame {
	...
	public void main(ArrayList<Integer> idPerguntas, int qtdVidas) {
		...
		System.out.println(idPerguntas);
	}
	...
	public Jogar(ArrayList<Integer> idPerguntas, int qtdVidas) {
		...
		JRadioButton resposta1 = new JRadioButton(pergunta.get("respostaCorreta"));
		...
		ArrayList<JRadioButton> respostasEmbaralhadas = Embaralhador.montaListaRespostasEmbaralhadas(respostas);
